...
<Collapsible title="Avalanche Order (by interest rate)">
...
<Collapsible title="Snowball Order (by balance)">
...
<Collapsible title="Closing cards after payoff" variant="warning">
...
<Collapsible title="Ignoring minimum payments" variant="warning">
...
<Collapsible title="No emergency fund" variant="warning">
...
<Collapsible title="Lifestyle inflation during payoff" variant="warning">
