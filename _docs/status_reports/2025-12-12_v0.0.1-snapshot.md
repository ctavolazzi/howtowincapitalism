...
|---|------------|-------------|--------|
| 01 | ![Login Page](../screenshots/auth-flow/v0.0.1/01-login-page.png) | Login form with email/password fields | ✅ Working |
| 02 | ![Login Error](../screenshots/auth-flow/v0.0.1/02-login-error.png) | Invalid credentials error message | ⚠️ Returns 401 |
| 03 | ![Login Success](../screenshots/auth-flow/v0.0.1/03-login-success.png) | Home page after successful login | ✅ Working |
| 04 | ![User Menu](../screenshots/auth-flow/v0.0.1/04-user-menu.png) | Logged-in state with user dropdown | ✅ Working |
| 05 | ![Profile Page](../screenshots/auth-flow/v0.0.1/05-profile-page.png) | User profile view | ✅ Working |
| 06 | ![Home Logged In](../screenshots/auth-flow/v0.0.1/06-home-logged-in.png) | Home page authenticated state | ✅ Working |
| 07 | ![Register Page](../screenshots/auth-flow/v0.0.1/07-register-page.png) | User registration form | ✅ Working |
...
| **Cookie Consent Banner** | 🔴 Critical | ✅ Yes | Required for EU compliance (HTTP cookie, fixed 2025-12-14) |
